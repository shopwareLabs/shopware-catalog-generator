        ...
        products: [
            {
                ...
                price: 29.99,
                stock: 10,
                primaryCategoryId: "cat1-sub",
                categoryIds: ["cat1-sub"],
                metadata: {
                    imageCount: 1 as const,
                    imageDescriptions: [{ view: "front" as const, prompt: "Test product image" }],
                    isVariant: false,
                ...
                products: [
                    {
                        ...
                        metadata: {
                            imageCount: 1 as const,
                            imageDescriptions: [
                                { view: "front" as const, prompt: "Test product image" },
                            ],
                            isVariant: false,
                            properties: [
